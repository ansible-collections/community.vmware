...
.. raw:: html
  ...
  <tr>
    ...
    <td>
      <p>Name of cluster.</p>
      <p>All host systems from given cluster used to manage exception users.</p>
  ...
  <tr>
    ...
    <td>
      <p>List of ESXi hostname to manage exception users.</p>
      <p>Required parameter, if <code class='docutils literal notranslate'>cluster_name</code> is not set.</p>
    </td>
  </tr>
  <tr>
    <td>
      <div class="ansibleOptionAnchor" id="parameter-exception_users"></div>
      <p style="display: inline;"><strong>exception_users</strong></p>
      <a class="ansibleOptionLink" href="#parameter-exception_users" title="Permalink to this option"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">list</span>
        / <span style="color: purple;">elements=string</span>
    ...
    <td>
      <p>List of Lockdown Mode Exception Users.</p>
      <p>To remove all Exception Users, <em>state=set</em> the empty list.</p>
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>
      <p>If <code class='docutils literal notranslate'>present</code>, make sure the given users are defined as Lockdown Mode Exception Users.</p>
      <p>If <code class='docutils literal notranslate'>absent</code>, make sure the given users are NO Lockdown Mode Exception Users.</p>
      <p>If <code class='docutils literal notranslate'>set</code>, will replace Lockdown Mode Exception Users defined list of users.</p>
...
.. raw:: html
  ...
  <tr>
    ...
    <td>
      <p>metadata about exception users of Host systems</p>
      <p style="margin-top: 8px;"><b>Returned:</b> always</p>
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><b style="color: black;">Sample:</b> <code>{&#34;host_lockdown_exceptions&#34;: {&#34;DC0_C0&#34;: {&#34;current_exception_users&#34;: [], &#34;desired_exception_users&#34;: [], &#34;previous_exception_users&#34;: [&#34;root&#34;]}}}</code></p>
    </td>
  </tr>
  </tbody>
  </table>
