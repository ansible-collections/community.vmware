...
.. _community.vmware.vmware_host_ssl_facts_module:
...
:Why: Deprecated in favour of :ref:`vmware_host_ssl_info <vmware_host_ssl_info_module>` module.
:Alternative: Use :ref:`vmware_host_ssl_info <vmware_host_ssl_info_module>` instead.
