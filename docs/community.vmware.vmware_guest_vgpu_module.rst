...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - 
      ...
      When \ :literal:`state=present`\ , the selected vGPU profile will be added if the VM hosted ESXi host NVIDIA GPU offer it.

      When \ :literal:`state=absent`\ , the selected vGPU profile gets removed from the VM.
