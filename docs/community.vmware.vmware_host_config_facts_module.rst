.. _community.vmware.vmware_host_config_facts_module:
...
**Gathers facts about an ESXi host's advance configuration information**
...
:Why: Deprecated in favour of :ref:`community.vmware.vmware_host_config_info <community.vmware.vmware_host_config_info_module>` module.
:Alternative: Use :ref:`community.vmware.vmware_host_config_info <community.vmware.vmware_host_config_info_module>` instead.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>dict with hostname as key and dict with host config facts</div>
                    <br/>
