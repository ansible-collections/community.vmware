...
:Why: Deprecated in favour of :ref:`vmware_host_vmhba_info <vmware_host_vmhba_info_module>` module.
:Alternative: Use :ref:`vmware_host_vmhba_info <vmware_host_vmhba_info_module>` instead.
