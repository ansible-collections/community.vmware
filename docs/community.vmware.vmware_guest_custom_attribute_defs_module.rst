...
To use it in a playbook, specify: :code:`community.vmware.vmware_guest_custom_attribute_defs`.
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="parameter-attribute_key"></div>
      <p style="display: inline;"><strong>attribute_key</strong></p>
      <a class="ansibleOptionLink" href="#parameter-attribute_key" title="Permalink to this option"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">string</span>
      </p>
    </div></td>
    <td>
      <p>Name of the custom attribute definition.</p>
      <p>This is required parameter, if <code class='docutils literal notranslate'>state</code> is set to <code class='docutils literal notranslate'>present</code> or <code class='docutils literal notranslate'>absent</code>.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="return-custom_attribute_defs"></div>
      <p style="display: inline;"><strong>custom_attribute_defs</strong></p>
      <a class="ansibleOptionLink" href="#return-custom_attribute_defs" title="Permalink to this return value"></a>
      <p style="font-size: small; margin-bottom: 0;">
    ...
    <td>
      <p>list of all current attribute definitions</p>
      <p style="margin-top: 8px;"><span style="font-weight: 700;">Returned:</span> always</p>
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><span style="color: black; font-weight: 700;">Sample:</span> <code>[&#34;sample_5&#34;, &#34;sample_4&#34;]</code></p>
    </td>
  </tr>
  </tbody>
  </table>
