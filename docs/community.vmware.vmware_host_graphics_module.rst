.. _community.vmware.vmware_host_graphics_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>consolidation</li>
                                    <li><div style="color: blue"><b>performance</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
                        <div>Shared passthrough GPU assignment policy</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div>All host system from given cluster used to manage Host Graphic Settings.</div>
            ...
            <tr>
                ...
                <td>
                        <div>List of ESXi hostname to manage Host Graphic Settings.</div>
