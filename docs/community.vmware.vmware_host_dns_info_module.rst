...
To use it in a playbook, specify: :code:`community.vmware.vmware_host_dns_info`.
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="return-hosts_dns_info"></div>
      <p style="display: inline;"><strong>hosts_dns_info</strong></p>
      <a class="ansibleOptionLink" href="#return-hosts_dns_info" title="Permalink to this return value"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">dictionary</span>
      </p>
    </div></td>
    <td>
      <p>metadata about DNS config from given cluster / host system</p>
      <p style="margin-top: 8px;"><span style="font-weight: 700;">Returned:</span> always</p>
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><span style="color: black; font-weight: 700;">Sample:</span> <code>{&#34;DC0_C0_H0&#34;: {&#34;dhcp&#34;: true, &#34;domain_name&#34;: &#34;localdomain&#34;, &#34;host_name&#34;: &#34;localhost&#34;, &#34;ip_address&#34;: [&#34;8.8.8.8&#34;], &#34;search_domain&#34;: [&#34;localdomain&#34;], &#34;virtual_nic_device&#34;: &#34;vmk0&#34;}}</code></p>
    </td>
  </tr>
  </tbody>
  </table>
