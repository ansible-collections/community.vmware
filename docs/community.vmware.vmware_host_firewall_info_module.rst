...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - 
      ...
      Sample: :literal:`{"esxi\_hostname\_0001": [{"allowed\_hosts": {"all\_ip": true, "ip\_address": ["10.10.10.1"], "ip\_network": ["11.111.112.0/22", "192.168.10.1/24"]}, "enabled": true, "key": "CIMHttpServer", "rule": [{"direction": "inbound", "end\_port": null, "port": 5988, "port\_type": "dst", "protocol": "tcp"}], "service": "sfcbd-watchdog"}]}`
