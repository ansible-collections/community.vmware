...
:Why: Deprecated in favour of :ref:`vmware_host_config_info <vmware_host_config_info_module>` module.
:Alternative: Use :ref:`vmware_host_config_info <vmware_host_config_info_module>` instead.
