...
:Why: Deprecated in favour of :ref:`vmware_host_package_info <vmware_host_package_info_module>` module.
:Alternative: Use :ref:`vmware_host_package_info <vmware_host_package_info_module>` instead.
