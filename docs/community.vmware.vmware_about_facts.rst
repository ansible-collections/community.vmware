...
:Why: Deprecated in favour of :ref:`vmware_about_info <vmware_about_info_module>` module.
:Alternative: Use :ref:`vmware_about_info <vmware_about_info_module>` instead.
