...
.. raw:: html
  ...
  <tr>
    <td>
      <div class="ansibleOptionAnchor" id="parameter-checks"></div>
      <p style="display: inline;"><strong>checks</strong></p>
      <a class="ansibleOptionLink" href="#parameter-checks" title="Permalink to this option"></a>
  ...
  <tr>
    ...
    <td>
      <p>The state of the health checks.</p>
      <p>If set to <code class='docutils literal notranslate'>present</code>, all given health checks will be silenced.</p>
      <p>If set to <code class='docutils literal notranslate'>absent</code>, all given health checks will be removed from the list of silent checks.</p>
