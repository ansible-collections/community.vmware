.. _community.vmware.vmware_host_ntp_facts_module:
...
:Why: Deprecated in favour of :ref:`community.vmware.vmware_host_ntp_info <community.vmware.vmware_host_ntp_info_module>` module.
:Alternative: Use :ref:`community.vmware.vmware_host_ntp_info <community.vmware.vmware_host_ntp_info_module>` instead.
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>NTP config facts about each ESXi server will be returned for the given cluster.</div>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>NTP config facts about this ESXi server will be returned.</div>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>hosts_ntp_facts</td>
                <td>
                            <div>dict with hostname as key and dict with NTP facts as value</div>
                    <br/>
