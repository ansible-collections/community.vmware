...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _parameter-override_user_password:
  ...
  * - .. raw:: html
    ...
    - 
      If set to \ :literal:`present`\ , add a new local user or update information.

      If set to \ :literal:`absent`\ , delete the local user.
  ...
  * - .. raw:: html
    ...
    - 
      ...
      If you'd like to update the password, require the \ :emphasis:`override\_user\_password`\  is true.
