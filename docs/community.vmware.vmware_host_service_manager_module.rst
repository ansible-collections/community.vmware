...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - 
      ...
      If set \ :literal:`on`\ , then service should be started when the host starts up.

      If set \ :literal:`automatic`\ , then service should run if and only if it has open firewall ports.

      If set \ :literal:`off`\ , then Service should not be started when the host starts up.
  ...
  * - .. raw:: html
    ...
    - 
      ...
      State value \ :literal:`unchanged`\  is added in version 1.14.0 to allow defining startup policy without defining or changing service state.
