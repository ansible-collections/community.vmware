...
To use it in a playbook, specify: :code:`community.vmware.vmware_guest_find`.
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    ...
    <td>
      ...
      <p>This is required if <code class='docutils literal notranslate'>uuid</code> parameter is not supplied.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
  ...
  <tr style="height: 100%;">
    ...
    <td>
      ...
      <p>This is required if <code class='docutils literal notranslate'>name</code> parameter is not supplied.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="return-folders"></div>
      <p style="display: inline;"><strong>folders</strong></p>
      <a class="ansibleOptionLink" href="#return-folders" title="Permalink to this return value"></a>
      <p style="font-size: small; margin-bottom: 0;">
    ...
    <td>
      <p>List of folders for user specified virtual machine</p>
      <p style="margin-top: 8px;"><span style="font-weight: 700;">Returned:</span> on success</p>
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><span style="color: black; font-weight: 700;">Sample:</span> <code>[&#34;/DC0/vm&#34;]</code></p>
    </td>
  </tr>
  </tbody>
  </table>
