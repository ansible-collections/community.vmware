...
To use it in a playbook, specify: :code:`community.vmware.vmware_host_config_manager`.
...
.. raw:: html
  ...
  <tr>
    ...
    <td>
      ...
      <p>Settings are applied to every ESXi host in given cluster.</p>
  ...
  <tr>
    ...
    <td>
      <p>ESXi hostname.</p>
      <p>Settings are applied to this ESXi host.</p>
  ...
  <tr>
    <td>
      ...
      <p style="display: inline;"><strong>options</strong></p>
    ...
    <td>
      <p>A dictionary of advanced system settings.</p>
      <p>Invalid options will cause module to error.</p>
      <p>Note that the list of advanced options (with description and values) can be found by running `vim-cmd hostsvc/advopt/options`.</p>
