...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="parameter-disk_name"></div>
      <p style="display: inline;"><strong>disk_name</strong></p>
      <a class="ansibleOptionLink" href="#parameter-disk_name" title="Permalink to this option"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">string</span>
        / <span style="color: red;">required</span>
      </p>
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>Disk storage size, an integer plus a unit.</p>
      <p>There is no space allowed in between size number and unit.</p>
      <p>Allowed units are MB, GB and TB.</p>
      <p>Examples:</p>
      <p>   size: 2048MB</p>
      <p>   size: 10GB</p>
      <p>   size: 1TB</p>
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>If the disk should be present or absent.</p>
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="return-first_class_disk"></div>
      <p style="display: inline;"><strong>first_class_disk</strong></p>
      <a class="ansibleOptionLink" href="#return-first_class_disk" title="Permalink to this return value"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">dictionary</span>
      </p>
    </div></td>
    <td>
      <p>First-class disk returned when created, deleted or changed</p>
