...
.. raw:: html
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>The vCenter datacenter name used to get specified cluster or host.</p>
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>VM folder, absolute or relative path to find an existing VM.</p>
      <p>This parameter is not required, only when multiple VMs are found with the same name.</p>
      <p>The folder should include the datacenter name.</p>
      <p>Examples:</p>
  ...
  <tr style="height: 100%;">
    ...
    <td>
      ...
      <p>This is required if parameter <code class='docutils literal notranslate'>uuid</code> or <code class='docutils literal notranslate'>moid</code> is not supplied.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>State of vTPM device.</p>
      <p>If set to &#x27;absent&#x27;, vTPM device will be removed from VM.</p>
      <p>If set to &#x27;present&#x27;, vTPM device will be added if not present.</p>
      <p>Virtual machine should be turned off before add or remove vTPM device.</p>
      <p>Virtual machine should not contain snapshots before add vTPM device.</p>
  ...
  <tr style="height: 100%;">
    ...
    <td>
      ...
      <p>This is required if parameter <code class='docutils literal notranslate'>name</code> or <code class='docutils literal notranslate'>moid</code> is not supplied.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>metadata about the VM vTPM device</p>
