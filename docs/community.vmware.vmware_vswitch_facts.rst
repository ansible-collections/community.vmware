...
:Why: Deprecated in favour of :ref:`vmware_vswitch_info <vmware_vswitch_info_module>` module.
:Alternative: Use :ref:`vmware_vswitch_info <vmware_vswitch_info_module>` instead.
