...
community.vmware.vmware_cluster_drs_recommendations module -- Apply DRS Recommendations
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
To use it in a playbook, specify: :code:`community.vmware.vmware_cluster_drs_recommendations`.
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>list of the recommendations</p>
      <p>What server moved from which host to which host.</p>
      <p style="margin-top: 8px;"><span style="font-weight: 700;">Returned:</span> always</p>
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><span style="color: black; font-weight: 700;">Sample:</span> <code>[&#34;server1 move from host1 to host2.&#34;, &#34;server2 move from host1 to host2.&#34;]</code></p>
    </td>
  </tr>
  </tbody>
  </table>
