...
.. raw:: html
  ...
  <tr>
    ...
    <td valign="top">
      ...
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><b style="color: black;">Sample:</b> <code>[&#34;server1 move from host1 to host2.&#34;, &#34;server2 move from host1 to host2.&#34;]</code></p>
    </td>
  </tr>
  </tbody>
  </table>
