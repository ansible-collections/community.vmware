...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - 
      If set to \ :emphasis:`present`\ , datastores specified by \ :emphasis:`datastores`\  will be added to the given datastore cluster.

      If set to \ :emphasis:`absent`\ , datastores specified by \ :emphasis:`datastores`\  will be moved from the given datastore cluster to datstore folder of the parent datacenter.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _return-datastore_cluster_info:
    ...
    - 
      ...
      Sample: :literal:`"{'changed\_datastores': ['ds\_171\_1'], 'current\_datastores': [], 'msg': None, 'previous\_datastores': ['ds\_171\_1']}"`
