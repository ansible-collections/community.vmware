...
:Why: Deprecated in favour of :ref:`vmware_guest_disk_info <vmware_guest_disk_info_module>` module.
:Alternative: Use :ref:`vmware_guest_disk_info <vmware_guest_disk_info_module>` instead.
