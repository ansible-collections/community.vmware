...
To use it in a playbook, specify: :code:`community.vmware.vmware_resource_pool_info`.
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="return-resource_pool_info"></div>
      <p style="display: inline;"><strong>resource_pool_info</strong></p>
      <a class="ansibleOptionLink" href="#return-resource_pool_info" title="Permalink to this return value"></a>
      <p style="font-size: small; margin-bottom: 0;">
