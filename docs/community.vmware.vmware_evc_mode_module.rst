...
To use it in a playbook, specify: :code:`community.vmware.vmware_evc_mode`.
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    ...
    <td>
      <p>The name of the cluster to enable or disable EVC mode on.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
    ...
    <td>
      <p>The name of the datacenter the cluster belongs to that you want to enable or disable EVC mode on.</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
      <div class="ansibleOptionAnchor" id="parameter-evc_mode"></div>
      <p style="display: inline;"><strong>evc_mode</strong></p>
      <a class="ansibleOptionLink" href="#parameter-evc_mode" title="Permalink to this option"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">string</span>
      </p>
    </div></td>
    <td>
      <p>Required for <code class='docutils literal notranslate'>state=present</code>.</p>
      <p>The EVC mode to enable or disable on the cluster. (intel-broadwell, intel-nehalem, intel-merom, etc.).</p>
    </td>
  </tr>
  <tr style="height: 100%;">
    <td style="height: inherit; display: flex; flex-direction: row;"><div style="padding: 8px 16px; border-top: 1px solid #000000; height: inherit; flex: 1 0 auto; white-space: nowrap; max-width: 100%;">
...
.. raw:: html
  ...
  <tr style="height: 100%;">
    ...
    <td>
      ...
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><span style="color: black; font-weight: 700;">Sample:</span> <code>&#34;EVC Mode for &#39;intel-broadwell&#39; has been enabled.&#34;</code></p>
    </td>
  </tr>
  </tbody>
  </table>
