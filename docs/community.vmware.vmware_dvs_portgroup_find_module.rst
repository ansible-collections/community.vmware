...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - 
      ...
      Basic containment check using python \ :literal:`in`\  operation.
  ...
  * - .. raw:: html
    ...
    - 
      ...
      Only relevant when \ :literal:`vlanid`\  is supplied.
...
.. list-table::
  ...
  * - .. raw:: html
    ...
    - 
      ...
      Sample: :literal:`[{"dvswitch": "vDS", "name": "N-51", "pvlan": true, "trunk": true, "vlan\_id": "0"}]`
