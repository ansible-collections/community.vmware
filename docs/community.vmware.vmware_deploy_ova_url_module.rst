.. _community.vmware.vmware_deploy_ova_url_module:


**************************************
community.vmware.vmware_deploy_ova_url
**************************************

**Deploys a VMware virtual machine from an OVA file placed on HTTP server**
